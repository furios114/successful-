...
const products = [
  {
    ...
    category: "hoodies",
    categoryName: "Худи",
    images: ["hoodie-3.png", "hoodie-4.png", "hoodie-5.png", "hoodie-6.png"],
    sizes: ["M", "L", "XL", "2XL"],
  ...
  {
    id: 4,
    name: "Футболка Successful Club — White Edition",
    price: 2490,
    category: "tshirts",
    categoryName: "Футболки",
    images: ["tshirt-3.png"],
    sizes: ["S", "M", "L", "XL", "2XL"],
    description: "Классическая белая футболка Successful Club. Чистый минимализм, который подчёркивает твой стиль и выделяет среди серой массы. Крой: свободный оверсайз (unisex), правильная геометрия посадки со спущенным плечом. Материал: 100% премиальный хлопок высокой плотности — 240 г/м². Держит форму, не деформируется после стирок, дышит и ощущается монументально на теле. Цвет: чистый белый (True White)."
  }
];